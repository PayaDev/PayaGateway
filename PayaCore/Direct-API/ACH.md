...
| billing .state                             | string  | The two-letter abbreviation of the state. Pattern: ^[\w'\-\s\.,#\/]{0,}$                                                                                                                                                                                    |
...
| shipping .state                            | string  | The two-letter abbreviation of the state. Pattern: ^[\w'\-\s\.,#\/]{0,}$                                                                                                                                                                                    |
